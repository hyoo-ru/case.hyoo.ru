...
declare namespace $ {
    class $hyoo_case_property extends $mol_store<boolean | string | number | readonly string[] | Record<string, string>> {
        id(): string;
        ...
        populate(): $hyoo_case_entity;
        join(target: $hyoo_case_entity): void;
        tear(index: number): void;
    }
}
